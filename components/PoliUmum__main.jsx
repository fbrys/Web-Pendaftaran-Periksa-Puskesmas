...
import ils from '../public/assets/patient-telling-physician-about-his-pain-health-problems-during-visit-hospital-young-man-complaining-about-back-kidney-ache-while-sitting-examination-bed-doctor-s-office.jpg';

function PoliUmum__main() {
  return (
      ...
      <div className="h-full w-auto max-w-[1230px] mx-auto flex justify-center items-center">
        <div className="mx-auto h-full w-screen bg-white  shadow-xl p-2 text-slate-500 text-sm leading-4 sm:text-base sm:leading-7 dark:bg-slate-800 dark:text-slate-400">
          ...
          <div className="py-2 text-start pb-8">
            ...
            <br />
            <p className="text-xl pt-2 pl-2 uppercase text-center">Poli Pemeriksaan Umum</p>
            <br />
            ...
            <hr />
            <br />
            <p className="text-xl pt-2 pl-2 uppercase text-center">Jadwal Poli Pemeriksaan Umum</p>
            <br />
